...
namespace infinicore::op::symv_impl::infiniop {

INFINIOP_CACHABLE_DESCRIPTOR(Descriptor, Symv, 100);
...
void run(void *planned_meta) {
    ...
    INFINICORE_CHECK_ERROR(infiniopSymv(
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(Symv, &plan, &run, &cleanup);
