...
namespace infinicore::op::symm_impl::infiniop {

INFINIOP_CACHABLE_DESCRIPTOR(Descriptor, Symm, 100);
...
void run(void *planned_meta) {
    ...
    INFINICORE_CHECK_ERROR(infiniopSymm(
...
INFINICORE_GRAPH_OP_REGISTER_ALLDEVICE(Symm, &plan, &run, &cleanup);
