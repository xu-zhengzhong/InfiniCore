...
public:
    ...
    static utils::Result<CopyInfo> createCopyInfo(
        infiniopTensorDescriptor_t x_desc,
        infiniopTensorDescriptor_t y_desc) {
        ...
        return utils::Result<CopyInfo>(
            CopyInfo(x_desc->numel(), x_desc->stride(0), y_desc->stride(0), x_desc->dtype()));
    }
};
