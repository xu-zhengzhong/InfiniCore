...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_F32:
        return CALCULATE_TPMV(float);
    case INFINI_DTYPE_F64:
        return CALCULATE_TPMV(double);
    default:
        return INFINI_STATUS_BAD_TENSOR_DTYPE;
    }
}

#undef CALCULATE_TPMV
