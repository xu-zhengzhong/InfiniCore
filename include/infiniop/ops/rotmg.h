...
__INFINI_C __export infiniStatus_t infiniopCreateRotmgDescriptor(
...
__INFINI_C __export infiniStatus_t infiniopGetRotmgWorkspaceSize(
    infiniopRotmgDescriptor_t desc,
    size_t *size);

__INFINI_C __export infiniStatus_t infiniopRotmg(
    infiniopRotmgDescriptor_t desc,
    void *workspace,
...
__INFINI_C __export infiniStatus_t infiniopDestroyRotmgDescriptor(
    infiniopRotmgDescriptor_t desc);
