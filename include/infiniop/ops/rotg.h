...
__INFINI_C __export infiniStatus_t infiniopCreateRotgDescriptor(
...
__INFINI_C __export infiniStatus_t infiniopGetRotgWorkspaceSize(
    infiniopRotgDescriptor_t desc,
    size_t *size);

__INFINI_C __export infiniStatus_t infiniopRotg(
    infiniopRotgDescriptor_t desc,
    void *workspace,
...
__INFINI_C __export infiniStatus_t infiniopDestroyRotgDescriptor(
    infiniopRotgDescriptor_t desc);
