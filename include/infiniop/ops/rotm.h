...
__INFINI_C __export infiniStatus_t infiniopCreateRotmDescriptor(
...
__INFINI_C __export infiniStatus_t infiniopGetRotmWorkspaceSize(
    infiniopRotmDescriptor_t desc,
    size_t *size);

__INFINI_C __export infiniStatus_t infiniopRotm(
    infiniopRotmDescriptor_t desc,
    void *workspace,
...
__INFINI_C __export infiniStatus_t infiniopDestroyRotmDescriptor(
    infiniopRotmDescriptor_t desc);
