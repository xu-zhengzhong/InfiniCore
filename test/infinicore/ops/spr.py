...
def torch_spr(alpha, x, out, *, uplo=0):
    result = _packed_rank1_update(out, x, alpha, uplo, x.shape[0])
    out.copy_(result)
    return out
...
class OpTest(BaseOperatorTest):
    """BLAS Level-2 spr operator test"""
    ...
    #     return torch_spr(*args, **kwargs)

    def infinicore_operator(self, *args, **kwargs):
        return infinicore.spr(*args, **kwargs)
